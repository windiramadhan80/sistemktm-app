                        ...
                        <div class="row">
                                ...
                                <table class="table table-sm table-borderless fw-bold ms-3">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>{{ request()->user()->tempat_lahir }},
                                                {{ request()->user()->tanggal_lahir }} {{ request()->user()->bulan_lahir }}
                                                {{ request()->user()->tahun_lahir }}</td>
                                        </tr>
                                        <tr>
                                            <td class="pe-0">Jenis Kelamin</td>
                                            <td>:</td>
                                            <td>{{ request()->user()->jenis_kelamin }}</td>
                                        </tr>
                                        <tr>
                                            <td class="pe-0">Program Studi</td>
                                            <td>:</td>
                                            <td>{{ request()->user()->program_studi }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="col">
                                <img src="{{ asset('storage/' . request()->user()->image) }}"
                                    class="rounded d-block mx-auto " width="100px" alt="...">
                                <p class="text-center mt-1 fw-bold">NIM. {{ request()->user()->nim }}</p>
                            </div>
                        </div>
